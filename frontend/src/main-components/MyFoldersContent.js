...
class MyFoldersContent extends React.Component {
	...
	async componentDidMount() {
		...
		this.setState({ isDataFetched: true, folders: foldersData }).catch((error) => {
			alert('Could not load cards, please try refreshing the page.');
		});
	}

	render() {
		let headingText = 'You have no folders at the moment. Please make a new folder by clicking on the side menu.';
