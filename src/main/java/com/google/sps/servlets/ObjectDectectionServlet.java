 ...
 * to this servlet. This servlet can then analyze the image using the Vision API and return the labels
 * for that image.
 */
@WebServlet("/ObjectDetection")
public class ImageAnalysisServlet extends HttpServlet {
  ...
  private BlobKey getBlobKey(HttpServletRequest request, String formInputElementName) {
    ...
    /**
      * In the case that the user hits submit without picking a file, 
      * delete the blobKey.
     */
