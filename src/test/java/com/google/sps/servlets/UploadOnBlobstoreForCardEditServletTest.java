...
public final class UploadOnBlobstoreForCardEditServletTest {
  ...
  private UploadOnBlobstoreForCardEditServlet servlet;

  @Before
  public void setUp() throws Exception {
    helper.setUp();
    servlet = new UploadOnBlobstoreForCardEditServlet();
